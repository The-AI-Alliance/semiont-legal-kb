 ...
 *   The yield.fromAnnotation call passes `entityTypes: ['Obligation']`,
 *   but @semiont/sdk's GenerationOptions doesn't declare an entityTypes
 *   field (see namespaces/types.ts:GenerationOptions and the bus payload
 *   in yield.ts:188-198). The field is silently dropped — synthesized
 *   Obligation resources don't get the 'Obligation' entity-type stamp,
 *   so `browse.resources({ entityType: 'Obligation' })` misses them.
 *   The bound annotations still carry the Obligation tag, so
